<template>
  <div class="bg-primary min-h-screen flex flex-col pb-10 backdrop-blur">
    ...
    <section class="flex-grow flex flex-col lg:flex-row justify-center items-center p-6 lg:pr-36 lg:pl-36">
      ...
      <div class="w-full lg:w-1/2 flex items-center lg:justify-end justify-center mt-6 lg:mt-0"> 
        <img src="https://media-public.canva.com/7bK5U/MAEjfy7bK5U/1/s.svg" alt="Image" class="w-96 md:w-108 lg:w-120 h-auto">
      </div>
    </section>
  </div>
</template>
